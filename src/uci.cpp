...
namespace {
    ...
    void generate_position(Position& pos, istringstream& is) {
        string token, fen;
    ...
    void get_moves(Position& pos, istringstream& is) {
        ...
        if (token == "legal") {
            get_moves_type<LEGAL>(pos, is);
        } else if (token == "captures") {
            get_moves_type<CAPTURES>(pos, is);
        } else if (token == "quiets") {
            get_moves_type<QUIETS>(pos, is);
        } else if (token == "quiet_checks") {
            get_moves_type<QUIET_CHECKS>(pos, is);
        } else if (token == "evasions") {
            get_moves_type<EVASIONS>(pos, is);
        } else if (token == "non_evasions") {
            get_moves_type<NON_EVASIONS>(pos, is);
        } else {
